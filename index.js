...
function createMenuItem(name1, price1, category1){
    const obj = {name: name1, price: price1, category: category1}
    return obj
}
...
const muffin = createMenuItem("Muffin", 3, "Bakery");
...
*/
reviews.push({name: "Trenten", rating: 4.5, feedback: "Good product"})
console.log(reviews);
